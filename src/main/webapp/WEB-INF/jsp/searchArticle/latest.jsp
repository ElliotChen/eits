...
<display:table name="${latestArticles.result}" partialList="true" pagesize="${latestArticles.pageSize}" size="${latestArticles.totalCount}" form="latestForm" sort="external" id="article" class="displayTagGrid">
