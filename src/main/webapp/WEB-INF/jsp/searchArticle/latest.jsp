...
<display:table name="${latestArticles.result}" partialList="true" pagesize="${latestArticles.pageSize}" size="${latestArticles.totalCount}" form="displaytagform" sort="external" id="article" class="displayTagGrid">
