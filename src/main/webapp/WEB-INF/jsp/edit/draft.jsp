...
<display:table name="${draftArticles.result}" partialList="true" pagesize="${draftArticles.pageSize}" size="${draftArticles.totalCount}" form="draftForm" sort="external" id="article" requestURI="edit!searchDraft.action" style="width:100%">
