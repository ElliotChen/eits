 ...
 *
 */
public class RejectUpdateMailTask extends MailTask {
	
	public RejectUpdateMailTask() {
		super();
	}

	public RejectUpdateMailTask(Long articleOid, JavaMailSender mailSender,
	...
	public String getTitle() {
		return "[Update Article Reject] KB System Notification ";
	}
