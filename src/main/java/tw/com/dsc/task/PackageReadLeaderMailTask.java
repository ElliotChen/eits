...
public class PackageReadLeaderMailTask extends PackageMailTask {
	
	public PackageReadLeaderMailTask() {
		super();
	}

	public PackageReadLeaderMailTask(Account receiver, String serverUrl,
